...
namespace FiscalFlow.Application.Validations.Cfdi.Validators;

public sealed class RetencionValidator : AbstractValidator<RetencionConceptoDto>
{
    public RetencionValidator()
    {
        RuleFor(x => x.Base)
           .GreaterThan(0)
